...
from grove.pyqaoa import analytical_gradient
from grove.pyqaoa import utils
...
def test_differentiate_unitary_sum():
    ...
    parameter = 1.0
    make_controlled = analytical_gradient.generate_make_controlled(2)
    p_unitary = analytical_gradient.exponential_map_hamiltonian(generator)
...
def test_differentiate_product_rule_one_ham():
    ...
    p_unitary_0 = analytical_gradient.exponential_map_hamiltonian(hamiltonian_0)
...
def test_differentiate_product_rule_two_hams():
    ...
    p_unitaries = [analytical_gradient.exponential_map_hamiltonian(hamiltonian)
