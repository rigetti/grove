...
def get_analytical_derivative_branches(unitary, generator,
    ...
    :return (list[pq.Program]) analytical_derivative_branches: each from a term
    """
    program_branches = hamiltonian_to_program_branches(generator,
        pauli_operator_mapping)
    analytical_derivative_branches = [program_branch + unitary for
...
def unitaries_list_to_analytical_derivatives_list_branches(step_index,
    ...
    """
    analytical_derivative_branches = get_analytical_derivative_branches(
