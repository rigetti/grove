# -*- coding: utf-8 -*-
#
# pyQAOA documentation build configuration file, created by
...
project = 'Grove'
copyright = '2016, Rigetti Quantum Computing'
...
latex_documents = [
    (master_doc, 'grove.tex', 'Grove Documentation',
     'Rigetti Quantum Computing', 'manual'),
]
...
man_pages = [
    (master_doc, 'grove', 'Grove Documentation',
     [author], 1)
]
